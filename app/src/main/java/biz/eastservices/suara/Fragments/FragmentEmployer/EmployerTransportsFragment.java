...
public class EmployerTransportsFragment extends Fragment {
    private static EmployerTransportsFragment INSTANCE=null;
    ...
    public EmployerTransportsFragment() {
    ...
    public static EmployerTransportsFragment getInstance(Location location)
    {
        if(INSTANCE == null)
            INSTANCE = new EmployerTransportsFragment();
        mLocation = location;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView)view.findViewById(R.id.recycler_transport);
