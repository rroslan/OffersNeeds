...
public class EmployerServicesFragment extends Fragment {

    private static EmployerServicesFragment INSTANCE=null;
    ...
    public EmployerServicesFragment() {
    ...
    public static EmployerServicesFragment getInstance(Location location)
    {
        if(INSTANCE == null)
            INSTANCE = new EmployerServicesFragment();
        mLocation = location;
